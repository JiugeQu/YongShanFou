...
axios.get("http://127.0.0.1:4523/m1/3576146-0-default/staff/order/in/progress", {
    headers: {
        ...
        ordersContainer.innerHTML = '';
         ...
         if(data.state === 2||3||4||5){
            data.data.forEach(order => {
                ...
                orderStatusElement.textContent = order.state === 5? '未评价' :"";
                ...
                viewDetailsTextElement.textContent = '查看详情';
                 ...
                 viewDetailsElement.addEventListener('click', function () {
                    // 导航到订单详情页面，并传递订单ID
                    // window.location.href = './订单详情.html?orderId=' + order.code;
                    window.location.href = './order _ details.html?orderId=' + '1721848915910721536'; // 根据实际数据结构调整
                });
